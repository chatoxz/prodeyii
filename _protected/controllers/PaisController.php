...
class PaisController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            Yii::$app->response->format = Response::FORMAT_JSON;
            $model->id = (Pais::find()->orderBy(['id' => SORT_DESC])->one()->id)+1;
            if($request->isGet){
                return [
                ...
                return [
                    ...
                    'title'=> "Crear nuevo Pais",
                    'content'=>'<span class="text-success">Create Pais success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            $model->id = (Pais::find()->orderBy(['anio' => SORT_DESC])->one()->id)+1;
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Pais model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
