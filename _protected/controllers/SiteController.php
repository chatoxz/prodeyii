...
//------------------------------------------------------------------------------------------------//
     ...
     * @return \yii\web\Response
     */
    public function actionEnviasms()
    {
        $emailenvia ="chosmalal@gmail.com"; /* Direccion de correo que envia */
        $empresasms= $_GET['empresa']; /* Recibo la Empresa del dest */
        $numero= $_GET['numerocel']; /* el numero del cel */
        $mensaje= $_GET['mensajeenv'];
        return $this->render('/site/enviasms',[
            'emailenvia' => $emailenvia,
            'empresasms' => $empresasms,
            'numero' => $numero,
            'mensaje' => $mensaje
        ]);
    }
    ...
    public function actionRequestPasswordReset()
    {
        ...
        return $this->redirect('/partido/fixture');
    }
